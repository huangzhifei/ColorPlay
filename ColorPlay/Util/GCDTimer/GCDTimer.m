...
- (instancetype) initScheduledTimerWithTimeInterval:(NSTimeInterval)interval
...
- (instancetype) initScheduledTimerWithTimeInterval:(NSTimeInterval)interval
                                            repeats:(BOOL)repeats
                                              block:(dispatch_block_t)block
{
    return self = [self initScheduledTimerWithTimeInterval:interval
                                                   repeats:repeats
...
+ (instancetype) scheduledTimerWithTimeInterval:(NSTimeInterval)interval
                                        repeats:(BOOL)repeats
                                          ...
                                          block:(dispatch_block_t)block
{
    return [[GCDTimer alloc] initScheduledTimerWithTimeInterval:interval
                                                        repeats:repeats
                                                          queue:queue
                                                          block:block];
}
